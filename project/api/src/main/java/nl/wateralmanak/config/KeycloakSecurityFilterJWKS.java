...
public class KeycloakSecurityFilterJWKS implements ContainerRequestFilter {

    private static final String KEYCLOAK_URL = System.getenv()
        .getOrDefault("KEYCLOAK_URL", "http://dev.localhost/auth");
    ...
    public void filter(ContainerRequestContext requestContext) {
        ...
        if (authHeader == null || !authHeader.startsWith("Bearer ")) {
            // System.err.println("wrong authHeader: " + authHeader);
